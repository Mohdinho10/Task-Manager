          ...
          return (
            <Link
              ...
              className={`flex w-full items-center gap-4 text-[15px] ${
                isActive
                  ? "text-primary border-primary border-r-4 bg-gradient-to-r from-blue-50/40 to-blue-100/50"
                  : "text-gray-700"
              } mb-3 cursor-pointer px-6 py-3 transition duration-150 hover:bg-blue-50`}
              onClick={() => {
